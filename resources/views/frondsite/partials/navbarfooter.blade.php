    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="footer-menu">
                    <div class="text-center">
                        <img class="img-center" src="images/logo2.png" width="70%" alt="logo">
                    </div>
            ...
            <div class="col-lg-8 col-md-6 col-sm-6 ">
                <div class="footer-menu">
                    <h5 class="widget-title">Layanan Customer</h5>
                    <p><b>Lorem ipsum</b> : Lorem ipsum dolor sit amet consectetur, adipisicing elit. Delectus modi quis
                        sit id
                        recusandae? Rem odit, doloribus ab quo illo similique quibusdam inventore qui! Voluptatum
                        laborum perspiciatis voluptatibus tenetur ad.</p>
                    <form>
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Email</label>
                                    <input type="email" class="form-control rounded-start rounded-0 bg-light"
                                        id="exampleInputEmail1" placeholder="Masukan email...">
                                </div>
                            </div>
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Pesan / Pengaduan</label>
                                    <textarea type="text" class="form-control rounded-start rounded-0 bg-light" id="exampleInputEmail1"
                        ...
                        <button type="submit" class="col-12 btn btn-dark">Kirim</button>
                    </form>
