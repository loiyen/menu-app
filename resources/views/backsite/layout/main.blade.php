        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <!-- Layouts -->
                    <li class="menu-item {{ request()->is('menu', 'kategori') ? 'active open' : ' ' }}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            <i class="menu-icon tf-icons bx bx-fork"></i>
                            <div class="text-truncate" data-i18n="Layouts">Menu</div>
                        </a>

                        <ul class="menu-sub">
                            <li class="menu-item ">
                                <a href="/menu" class="menu-link ">
                                    <div class="text-truncate" data-i18n="Without menu">Menu</div>
                                </a>
                            </li>

                            <li class="menu-item">
                                <a href="/kategori" class="menu-link">
                                    <div class="text-truncate" data-i18n="Blank">Kategori</div>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu-item {{ request()->is('meja') ? 'active open' : ' ' }}">
                        <a href="/meja" class="menu-link ">
                            <i class="menu-icon tf-icons bx bx-chair"></i>
                            <div class="text-truncate">Meja</div>
                        </a>
                    ...
                    <!-- Forms -->
                    <li class="menu-item {{ request()->is('akun') ? 'active open' : ' ' }} ">
                        <a href="/akun" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-cog"></i>
                            <div class="text-truncate" data-i18n="Form Elements">Akun</div>
                        </a>
